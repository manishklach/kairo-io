#!/usr/bin/env python3
"""
parse_stage7_backend_summary.py

Parses Stage 7 backend mapping summary.log files and emits CSV or
pretty-printed tables.

Usage:
    python3 parse_stage7_backend_summary.py results/stage7/*/summary.log --csv
    python3 parse_stage7_backend_summary.py results/stage7/*/summary.log --pretty
    cat summary.log | python3 parse_stage7_backend_summary.py --csv
"""
...
def main():
    ...
    if paths:
        ...
        text = sys.stdin.read()
        rows = [make_row(r) for r in [parse_summary(text)]]
